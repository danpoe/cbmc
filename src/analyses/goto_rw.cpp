  ...
  const exprt &object_expr)
{
  ...
  {
    get_objects_rec(READ, if_expr.cond(), object_expr);
  ...
  const exprt &object_expr)
{
  ...
  get_objects_rec(READ, pointer, pointer);
  if(mode!=READ)
  ...
  const exprt &object_expr)
{
  ...
  if(object.id()==ID_string_constant ||
    ...
    get_objects_rec(READ, object, object_expr);
  ...
  else if(object.id()==ID_index)
  {
    ...
    get_objects_rec(READ, index.array(), object_expr);
  ...
  else if(object.id()==ID_member)
  {
    ...
    get_objects_rec(READ, member.struct_op(), object_expr);
  }
...
void rw_range_sett::add(
  ...
  const exprt &object_expr)
{
  objectst &objects=mode==LHS_W?w_range_set:r_range_set;

  auto r=objects.insert(
    std::make_pair<const irep_idt &, range_domain_baset *>(identifier, NULL));
...
Function: rw_range_set_objectst::get_objects_if
...
Function: rw_range_set_objectst::get_objects_index
             ...
             rw_range_sett &rw_set)
{
  ...
  forall_expr(it, function_call.arguments())
  {
    ...
    if(type.id()==ID_pointer)
    {
      ...
      rw_set.get_objects_rec(target, rw_range_sett::LHS_W, de);
    }
  }
}
